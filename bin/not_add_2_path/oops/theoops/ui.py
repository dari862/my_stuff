...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[theoops.oopstypes.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype theoops.oopstypes.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[theoops.oopstypes.CorrectedCommand]
    :rtype: theoops.oopstypes.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No oopss given' if get_alias() == 'oops'
                    else 'Nothing found')
        return
