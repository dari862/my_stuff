...
if [ "$(id -u)" -ne 0 ]; then
	popup_terminal --superuser "$0 $__distro_path_lib"
	exit	
fi
...
case "${screen}" in
	1080p)	gfxmode="GRUB_GFXMODE=1920x1080,auto" ;;
	2k)		gfxmode="GRUB_GFXMODE=2560x1440,auto" ;;
	4k)		gfxmode="GRUB_GFXMODE=3840x2160,auto" ;;
esac
