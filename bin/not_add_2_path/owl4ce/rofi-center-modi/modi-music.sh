...
case "${@}" in
    "$A") /usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music prev
    ;;
    "$B") /usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music toggle
    ;;
    "$C") /usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music next
    ;;
    "$D") /usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music stop
    ;;
    "$E") mpc -p "$CHK_MPD_PORT" single -q
    ;;
esac

MESSAGE="$(/usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music title)"
...
[ -n "$(/usr/share/my_stuff/bin/not_add_2_path/owl4ce/owl4ce_scripts music status)" ] && P_A='1' || P_U='1'
