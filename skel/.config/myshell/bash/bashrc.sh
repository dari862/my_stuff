...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]${ssh_message}:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@\h${ssh_message}:\w\$ '
fi
...
if [ -f ~/.config/myshell/bash_aliases ]; then
    . ~/.config/myshell/bash_aliases
fi
